...
(echo if /i "%%SecureBootExist%%"=="True" echo.) >> "%ProgramData%\Microsoft\Windows\Start Menu\Programs\Startup\Secure Boot Updater.bat"
(echo if /i "%%SecureBoot%%"=="    UEFICA2023Status    REG_SZ    Updated" echo Secure boot has been updated. Press any key to close this batch file.) >> "%ProgramData%\Microsoft\Windows\Start Menu\Programs\Startup\Secure Boot Updater.bat"
(echo if /i not "%%SecureBoot%%"=="    UEFICA2023Status    REG_SZ    Updated" echo There has been an error and Secure boot has not been updated. Press any key to close this batch file.) >> "%ProgramData%\Microsoft\Windows\Start Menu\Programs\Startup\Secure Boot Updater.bat"
